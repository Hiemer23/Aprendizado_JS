...
sorteado internamente. Se o valor fornecido foi o sorteado, retorne "Parabéns!
O número sorteado foi o X". Se não for igual, retorne "Que pena! O número
...
const funcaoDaSorte = (num) => {
    ...
    sorteio==num?console.log("Parabéns! O número sorteado foi o ",num):console.log("Que pena! O número sorteado foi o ",sorteio)
}
funcaoDaSorte(10) // retornará "Parabéns! O número sorteado foi o 10"
funcaoDaSorte(5) // retornará "Que pena! O número sorteado foi o 3"
funcaoDaSorte(5) // retornará "Que pena! O número sorteado foi o 1"*/