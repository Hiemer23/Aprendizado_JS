...
Crie uma função que receba um array de produtos e retorne o total das despesas. Exemplos:
despesasTotais([
...
*/
const despesasTotais = (vet) => {
    let soma = vet.map(elemento => elemento.preco).reduce((x, y) => x + y)
